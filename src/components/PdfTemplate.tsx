...
const renderToolIcon = (name: string) => {
  if (name === 'Figma') return (
    <svg viewBox="0 0 38 57" className="w-6 h-6">
      <path d="M19 28.5c0-2.652 1.054-5.196 2.929-7.071C23.804 19.554 26.348 18.5 29 18.5s5.196 1.054 7.071 2.929C37.946 23.304 39 25.848 39 28.5s-1.054 5.196-2.929 7.071C34.196 37.446 31.652 38.5 29 38.5s-5.196-1.054-7.071-2.929C20.054 33.696 19 31.152 19 28.5z" fill="#1ABCFE"/>
      <path d="M0 47.5C0 44.848 1.054 42.304 2.929 40.429 4.804 38.554 7.348 37.5 10 37.5s5.196 1.054 7.071 2.929C18.946 42.304 20 44.848 20 47.5s-1.054 5.196-2.929 7.071C15.196 56.446 12.652 57.5 10 57.5s-5.196-1.054-7.071-2.929C1.054 52.696 0 50.152 0 47.5z" fill="#0ACF83"/>
      <path d="M0 28.5C0 25.848 1.054 23.304 2.929 21.429 4.804 19.554 7.348 18.5 10 18.5h10v20H10c-2.652 0-5.196-1.054-7.071-2.929C1.054 33.696 0 31.152 0 28.5z" fill="#A259FF"/>
      <path d="M0 9.5C0 6.848 1.054 4.304 2.929 2.429 4.804 0.554 7.348 0 10 0h10v19H10c-2.652 0-5.196-1.054-7.071-2.929C1.054 14.196 0 11.652 0 9.5z" fill="#F24E1E"/>
      <path d="M20 0h10c2.652 0 5.196 1.054 7.071 2.929C38.946 4.804 40 7.348 40 10c0 2.652-1.054 5.196-2.929 7.071C35.196 18.946 32.652 20 30 20H20V0z" fill="#FF7262"/>
    </svg>
  );
  ...
  if (TOOL_PATHS[name]) return (
    <svg viewBox="0 0 24 24" className="w-6 h-6" fill={colors[name] || 'currentColor'}>
      <path d={TOOL_PATHS[name]} />
    </svg>
  );
