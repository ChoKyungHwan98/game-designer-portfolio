...
export const RESUME_DATA: ResumeData = {
  ...
  selfIntroductions: [
    ...
    {
      navTitle: "핵심 역량",
      logline: "저는 기획 의도를 알고,  \n**목차를 작성할 줄 압니다.**",
      hook: "저는 원래 논리적인 사람이 아니었습니다. 문학을 좋아하는 감성적인 학생이었고, 그것이 법학을 배우는 과정에서 가장 큰 벽이 되었습니다.\n\n대학교 2학년 형법 시험에서 <strong>C학점</strong>을 받았습니다. 교수님께 피드백을 받으러 찾아갔고, 교수님은 말없이 1등 학생의 답안을 보여주셨습니다.\n\n그 답안에서 <strong>목차</strong>가 눈에 들어왔습니다. 대전제에서 소전제로, 논리의 위계가 한눈에 보였고, 내용이 그 구조에 따라 자연스럽게 읽혔습니다.\n\n부끄러웠습니다. 제 답안에는 <strong>목차가 없었습니다.</strong> 그날부터 목차를 작성하는 훈련을 시작했습니다. 법학 답안은 다음 구조를 따릅니다.",
      highlights: [
        { bold: "문제상황", em: "쟁점의 제기 및 사실관계의 확정" },
        { bold: "학설", em: "주요 견해 대립 및 논거의 제시" },
        { bold: "판례", em: "판결 요지 및 실질적 판단 기준 설시" },
        { bold: "검토", em: "학설의 비판적 검토 및 사안의 포섭" }
      ],
      body: "매 시험마다 <strong>핵심 주장을 한 문장으로 정한 뒤</strong>, 모든 항목이 그것을 관통하는지 반복해서 검증했습니다. 주장이 흔들리면 목차 전체가 무너졌고, 목차가 무너지면 답안 전체가 설득력을 잃었습니다. <strong>7년 동안 이 실패를 반복하며</strong> 구조를 다듬었습니다.\n\n그 훈련의 성과는 <strong>졸업 논문</strong>이었습니다. 다른 학생들이 자료를 먼저 뒤지고 본문부터 채워나갈 때, 저는 <strong>목차를 먼저 완성</strong>했습니다.\n\n탄탄한 목차가 완성된 뒤 본문 작성은 그 내용을 채우는 일에 불과했고, 그 결과 누구보다 빠르게 논문을 완성했습니다. 결과는 <strong>95점</strong>이었습니다.",
      closing: "<strong>설득력 있는 주장은 논리가 아니라, 그 논리를 담는 구조에서 나옵니다.</strong> 기획 의도를 알고 목차를 작성하는 능력은, 7년간의 실패가 만들어준 저의 역량입니다."
    },
    {
      navTitle: "AI 활용 능력",
      logline: "목차를 작성하는 능력은  \n**AI에 적용할 수 있습니다.**",
      hook: "팀 프로젝트를 진행하던 중, <strong>회의록 작성이 매번 작업 시간을 빼앗는</strong> 문제가 발생했습니다.\n\n이를 해결하기 위해 저는 AI봇 설계 도구인 Eve를 활용해 <strong>LLM 기반 회의록 자동화 봇</strong>을 직접 기획하고 구축했습니다.\n\n봇이 채워야 할 회의록 양식을 지식팩으로 구성한 뒤, 가장 중요한 프롬프트 구조를 아래와 같이 체계적으로 지시했습니다.",
      highlights: [
        { bold: "Role", em: "봇의 역할과 맥락을 정의" },
        { bold: "Goals", em: "목표와 산출물 형식을 결정" },
  ...
  tools: [
    ...
    { name: "ChatGPT", description: "방대한 데이터 크롤링 및 분석을 통한 기획 소스 확보 및 구조적 데이터 정제" },
    { name: "Gemini", description: "고도화된 프롬프트 엔지니어링을 활용해 기획에 필요한 핵심 로직 및 아이디어 즉각 생성" },
    { name: "Claude", description: "최신 바이브코딩 기법을 적용하여 복잡한 시스템 기획 사양의 코드 구현 및 검증" },
